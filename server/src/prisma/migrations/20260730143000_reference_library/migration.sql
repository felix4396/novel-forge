ALTER TYPE "KnowledgeDocumentKind" ADD VALUE IF NOT EXISTS 'reference_import';
...
CREATE TABLE "ReferenceSearchJob" (
  ...
  CONSTRAINT "ReferenceSearchJob_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ReferenceBookSource" (
  ...
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL,
  CONSTRAINT "ReferenceBookSource_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ReferenceDownloadJob" (
  ...
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL,
  CONSTRAINT "ReferenceDownloadJob_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "ReferenceBook" ADD CONSTRAINT "ReferenceBook_knowledgeDocumentId_fkey" FOREIGN KEY ("knowledgeDocumentId") REFERENCES "KnowledgeDocument"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ReferenceBookSource" ADD CONSTRAINT "ReferenceBookSource_bookId_fkey" FOREIGN KEY ("bookId") REFERENCES "ReferenceBook"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "ReferenceDownloadJob" ADD CONSTRAINT "ReferenceDownloadJob_bookId_fkey" FOREIGN KEY ("bookId") REFERENCES "ReferenceBook"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "ReferenceDownloadJob" ADD CONSTRAINT "ReferenceDownloadJob_searchJobId_fkey" FOREIGN KEY ("searchJobId") REFERENCES "ReferenceSearchJob"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ReferenceDownloadJob" ADD CONSTRAINT "ReferenceDownloadJob_currentSourceId_fkey" FOREIGN KEY ("currentSourceId") REFERENCES "ReferenceBookSource"("id") ON DELETE SET NULL ON UPDATE CASCADE;
