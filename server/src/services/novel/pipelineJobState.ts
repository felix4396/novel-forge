...
export function parsePipelinePayload(payload: string | null | undefined): PipelinePayload {
  ...
  try {
    ...
    return {
      ...
      aiWorkbenchAgentRunId: typeof parsed.aiWorkbenchAgentRunId === "string" ? parsed.aiWorkbenchAgentRunId : undefined,
...
export function stringifyPipelinePayload(input: PipelinePayload): string {
  ...
  return JSON.stringify({
    ...
    ...(input.aiWorkbenchAgentRunId?.trim() ? { aiWorkbenchAgentRunId: input.aiWorkbenchAgentRunId.trim() } : {}),
