...
export const runtimeContinuationSchema = z.object({
  enabled: z.boolean(),
  sourceType: z.enum(["novel", "knowledge_document", "reference_corpus"]).nullable(),
...
export const runtimeActiveSkillSchema = z.object({
  skillId: z.string(),
  ...
  conflictStatus: z.string().default("ok"),
  conflictJson: z.string().default("[]"),
  conflictKeys: z.array(z.string()).default([]),
  stateRequirements: z.array(z.string()).default([]),
  promptHooks: z.record(z.string(), z.string()).default({}),
  reviewGateChecks: z.array(z.string()).default([]),
  riskTriggers: z.array(z.string()).default([]),
  visualFocus: z.array(z.string()).default([]),
  config: z.record(z.string(), z.unknown()).default({}),
  metadata: z.record(z.string(), z.unknown()).default({}),
});

export const runtimeRagReferenceSchema = z.object({
  id: z.string(),
  ownerType: z.string(),
  ownerId: z.string(),
  title: z.string().nullable().optional(),
  source: z.enum(["vector", "keyword", "reranked"]).or(z.string()),
...
export const chapterWriteContextSchema = z.object({
  ...
  activeSkills: z.array(runtimeActiveSkillSchema).default([]),
...
export const generationContextPackageSchema = z.object({
  ...
  ragReferences: z.array(runtimeRagReferenceSchema).default([]),
...
export type RuntimeActiveSkill = z.infer<typeof runtimeActiveSkillSchema>;
